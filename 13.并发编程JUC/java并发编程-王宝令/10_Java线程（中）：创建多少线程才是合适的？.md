...
[![](image/10_Java线程（中）：创建多少线程才是合适的？/d1d7dfa1d574356cc5cb1019a4b7ca22-1674132800302-11.png)](https://static001.geekbang.org/resource/image/d1/22/d1d7dfa1d574356cc5cb1019a4b7ca22.png)

单线程执行示意图

如果有两个线程，如下图所示，当线程 A 执行 CPU 计算的时候，线程 B 执行 I/O 操作；当线程 A 执行 I/O 操作的时候，线程 B 执行 CPU 计算，这样 CPU 的利用率和 I/O 设备的利用率就都达到了 100%。

[![](image/10_Java线程（中）：创建多少线程才是合适的？/68a415b31b72844eb81889e9f0eb3f2c.png)](https://static001.geekbang.org/resource/image/68/2c/68a415b31b72844eb81889e9f0eb3f2c.png)
...
[![](image/10_Java线程（中）：创建多少线程才是合适的？/95367d49f55e0dfd099f2749c532098c.png)](https://static001.geekbang.org/resource/image/95/8c/95367d49f55e0dfd099f2749c532098c.png)
...
[![](image/10_Java线程（中）：创建多少线程才是合适的？/98b71b72f01baf5f0968c7c3a2102fcb.png)](https://static001.geekbang.org/resource/image/98/cb/98b71b72f01baf5f0968c7c3a2102fcb.png)
...
> 大部分应用环境是合理的，觉得公式话性能问题有些不妥，定性的io密集或者cpu密集很难在定量的维度上反应出性能瓶颈，而且公式上忽略了线程数增加带来的cpu消耗，性能优化还是要定量比较好，这样不会盲目，比如io已经成为了瓶颈，增加线程或许带来不了性能提升，这个时候是不是可以考虑用cpu换取带宽，压缩数据，或者逻辑上少发送一些。