# [HashMap](https://www.xiaogenban1993.com/blog/23.01/java_Map#1-hashmap)
...
![image](./images/free_code的ConcurrentHashMap细节介绍/wUd5joH-1769536714842-2-1769536762166-2.png)

## [1.1 红黑树](https://www.xiaogenban1993.com/blog/23.01/java_Map#11-红黑树)
...
![image](./images/free_code的ConcurrentHashMap细节介绍/6dRCZTl-1769532482792-19.png)
...
## [1.2 为什么是2的幂次方](https://www.xiaogenban1993.com/blog/23.01/java_Map#12-为什么是2的幂次方)
...
# [2 LinkedHashMap](https://www.xiaogenban1993.com/blog/23.01/java_Map#2-linkedhashmap)
...
![image](./images/free_code的ConcurrentHashMap细节介绍/4rIrVrZ-1769532476911-15-1769532482795-27.png)

# [3 TreeMap](https://www.xiaogenban1993.com/blog/23.01/java_Map#3-treemap)

`TreeMap`是一颗纯红黑树，插入和查询的复杂度都成了`O(logn)`，他主要特点是节点的有序性，会按照key的大小顺序排序。遍历的时候是按照大小顺序，从小到大迭代。

# [4 Hashtable](https://www.xiaogenban1993.com/blog/23.01/java_Map#4-hashtable)

`Hashtable`是加锁版本的`HashMap`，对所有的方法添加了`synchronized`关键字修饰，使每一种操作都需要锁住整个数据结构，优点就是没有并发问题，缺点是锁的代价高，性能较差。

# [5 ConcurrentHashMap](https://www.xiaogenban1993.com/blog/23.01/java_Map#5-concurrenthashmap)

`ConcurrentHashMap`是一种性能较高的并发`HashMap`，他的底层存储结构与`HashMap`一致，只不过使用了`CAS`和对单个桶`synchronized`的方法，减小了锁的范围换来了更高的性能。

有五种节点，如下。

![image](./images/free_code的ConcurrentHashMap细节介绍/7x48p8E-1769532482792-21.png)

扩容的简图，如下。

![image](./images/free_code的ConcurrentHashMap细节介绍/7YvjbUf-1769532482792-23.png)
...
## [5.1 经典案例](https://www.xiaogenban1993.com/blog/23.01/java_Map#51-经典案例)
...
# [6 scala: mutable.HashMap](https://www.xiaogenban1993.com/blog/23.01/java_Map#6-scala-mutablehashmap)
...
# [7 scala immutable.HashMap](https://www.xiaogenban1993.com/blog/23.01/java_Map#7-scala-immutablehashmap)
...
![image](./images/free_code的ConcurrentHashMap细节介绍/capb8AR-1769532482795-25.png)
