...
![image-20200704111417472](images/01-JVM与Java体系结构/4f09fe3576573558bdc61985a8ad6a42-1697475407855-26.png)
...
![image-20200704112119729](images/01-JVM与Java体系结构/b8b64926837d355213a8ce16c119da6b.png)
...
![image-20200704112700211](images/01-JVM与Java体系结构/8fd76611be7ea81ebcfe7c4065dd3294.png)
...
![image-20210507095948516](images/01-JVM与Java体系结构/555790a8a0b57075bdc8b6116545e461.png)

![image-20200704145340513](images/01-JVM与Java体系结构/33c00a1933a8fbdf47db211178125621.png)

![image-20210507100021400](images/01-JVM与Java体系结构/f4cd25ee025347ae9481e26b89331041.png)

![image-20210507100104455](images/01-JVM与Java体系结构/c56a02961383aca01f642eb9a1b81ab1.png)
...
- 作为灯种文化，Java 几乎成为了“开源”的代名词。
  ...
  - 就连 JDK 和 JVM 自身也有不少开源的实现，如 openJDK、Harmony【Apache】。
- 作为一个社区，Java 拥有全世界最多的技术拥护者和开源社区支持，有数不清的论坛和资料。从桌面应用软件、嵌入式开发到企业级应用、后台服务器、中间件，都可以看到 Java 的身影。其应用形式之复杂、参与人数之众多也令人咋舌。

![image-20200704151731216](images/01-JVM与Java体系结构/69fa9f3a1421d7dffc8b193084c8ae04.png)
...
![image-20200704152052489](images/01-JVM与Java体系结构/a9546b59e32abb4cc36b02b2f72bddad.png)
...
![image-20210507102334642](images/01-JVM与Java体系结构/b97b2bf5eafd843f7b149e98ff4d615f.png)
...
![image-20200704182035810](images/01-JVM与Java体系结构/577ba2f5110b972116602fb2ce3291e8.png)
...
![img](images/01-JVM与Java体系结构/8a37d7f7b848e7453e622270217ce7dc.png)

## 1.5. 虚拟机与 Java 虚拟机

**虚拟机**

所谓虚拟机（Virtual Machine），就是一台虚拟的计算机。它是一款软件，用来执行一系列虚拟计算机指令。大体上，虚拟机可以分为<mark>系统虚拟机</mark>和<mark>程序虚拟机</mark>。
...
- <mark>Java 虚拟机就是二进制字节码的运行环境</mark>，负责装载字节码到其内部，解释/编译为对应平台上的机器指令执行。每一条 Java 指令，Java 虚拟机规范中都有详细定义，如怎么取操作数，怎么处理操作数，处理结果放在哪里。
...
![image-20200704183048061](images/01-JVM与Java体系结构/6b5c24b8d634d5a741ef5d8a90db1123.png)

JVM 是运行在操作系统之上的，它与硬件没有直接的交互
![image-20210507104030823](images/01-JVM与Java体系结构/cd8b795cf080b8ba40f6915b6242c8af.png)
...
java [options] -jar filename [args]
	...
	- options：命令行选项以空格分隔  标准参数检查 JRE 版本、设置类路径、启用详细输出等。非标准选项是特定于 Java HotSpot 虚拟机VM的通用选项
	- classname：要启动的类的名称
	- filename：要调用的 Java Archive (JAR) 文件的名称。仅与选项一起使用-jar

	- args：传递给 main (args)方法的参数由空格分隔。
...
![image-20200704183436495](images/01-JVM与Java体系结构/1bf0b96d082d684a818bc36a8f864a89.png)
...
![image-20200704210429535](images/01-JVM与Java体系结构/4ce09e21efc2533d2b80f45f97b35a48.png)
...
![image-20221213235547208](images/01-JVM与Java体系结构/image-20221213235547208.png)
...
- <mark>专注于服务器端应用</mark>
  ...
  - 它可以<mark>不太关注程序启动速度</mark>，因此 JRockit <mark>内部不包含解析器实现</mark>，<mark>全部代码都靠即时编译器编译后执行</mark>。
...
- 目前，<mark>有影响力的三大商用虚拟机之一</mark>，也号称是世界上最快的 Java 虚拟机。
...
- <mark>Dalvik VM 只能称作虚拟机，而不能称作“Java 虚拟机”</mark>，它没有遵循 Java 虚拟机规范，不能直接执行 Java 的 Class 文件
...
- 2018 年 4 月，oracle Labs 公开了 Graal VM，号称 <mark>"Run Programs Faster Anywhere"</mark>，野心勃勃。与 1995 年 java 的”write once，run anywhere"遥相呼应。
- Graal VM 在 HotSpot VM 基础上增强而成的<mark>跨语言全栈虚拟机，可以作为“任何语言” 的运行平台使用</mark>。语言包括：Java、Scala、Groovy、Kotlin；C、C++、Javascript、Ruby、Python、R 等
...
- <mark>如果说 HotSpot 有一天真的被取代，Graal VM 希望最大</mark>。但是 Java 的软件生态没有丝毫变化。
