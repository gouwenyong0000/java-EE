...
import com.phei.netty._8_protocol.http.json.pojo.JsonEncodeDecode;
 ...
 * @date 2014年3月1日
 */
public abstract class AbstractHttpJsonEncoder<T> extends
    ...
    protected ByteBuf encode0(ChannelHandlerContext ctx, Object body)
        ...
        String encoder = JsonEncodeDecode.encoder((Order) body);
        ByteBuf encodeBuf = Unpooled.copiedBuffer(encoder, UTF_8);
        return encodeBuf;
    }
