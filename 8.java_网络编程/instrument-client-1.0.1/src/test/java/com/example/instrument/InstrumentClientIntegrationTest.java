...
class InstrumentClientIntegrationTest {
    ...
    static void startServer() throws Exception {
        testServer = new TestServer(PORT, true);
    ...
    void testRequestResponse() throws Exception {
        ...
        assertEquals("TestServer,Model-1000,SN12345,1.0.0", response.text(StandardCharsets.UTF_8));
    }
    
    @Test
    @DisplayName("equalsText 精确匹配 —— STATUS? 响应必须严格等于 OK")
