...
Thread类实际上也是实现了Runnable接口的类。（代理模式）即：

```java
public class Thread extends Object implements Runnable
    
   
Thread类为什么能启动Runnable接口，因为Thread中run方法 调用了Runnable接口的run方法
    /* What will be run. */
...
* void join() ：等待该线程终止。 在线程a中通过线程b调用join()，意味着线程a进入阻塞状态，直到线程b执行结束，线程a才结束阻塞状态，继续执行。
...
> 注意：继承Thread类创建线程，非静态的成员变量每个类在堆中开辟的空间，不涉及共享变量操作。
...
问题：局部变量是每次调用方法都是独立的，那么每个线程的run()的ticket是独立的【方法内局部变量】，不是共享数据。
...
class TicketWindow extends Thread {
    private int ticket = 100;//继承Thread模式的成员变量不是共享资源
...
public class LazyOne {
    ...
    //方式3： 双重校验锁  DCL，即 double-checked locking
    ...
    /*
    注意：上述方式3中，instance = new LazyOne()有指令重排问题
...
2023-05-17 01:11:42 Full thread dump OpenJDK 64-Bit Server VM (17.0.2+8-86 mixed mode, sharing):

Threads class SMR info:
_java_thread_list=0x00000228649a2f30, length=15, elements={
0x0000022864803840, 0x0000022864804d60, 0x0000022864815a40, 0x0000022864816500,
0x0000022864819570, 0x000002286481a5d0, 0x0000022864826970, 0x000002286482ce50,
0x000002286482e300, 0x000002286492e6c0, 0x000002286492eb90, 0x000002286492f530,
0x00000228649316e0, 0x0000022864931bb0, 0x000002286492fed0
}

"Reference Handler" #2 daemon prio=10 os_prio=2 cpu=0.00ms elapsed=66.20s tid=0x0000022864803840 nid=0x5c70 waiting on condition  [0x00000035b02ff000]
...
"Finalizer" #3 daemon prio=8 os_prio=1 cpu=0.00ms elapsed=66.20s tid=0x0000022864804d60 nid=0x2a84 in Object.wait()  [0x00000035b03ff000]
   java.lang.Thread.State: WAITING (on object monitor)
        at java.lang.Object.wait(java.base@17.0.2/Native Method)
        - waiting on <0x000000069a40d5c8> (a java.lang.ref.ReferenceQueue$Lock)
        at java.lang.ref.ReferenceQueue.remove(java.base@17.0.2/ReferenceQueue.java:155)
        - locked <0x000000069a40d5c8> (a java.lang.ref.ReferenceQueue$Lock)
...
"Signal Dispatcher" #4 daemon prio=9 os_prio=2 cpu=0.00ms elapsed=66.17s tid=0x0000022864815a40 nid=0x5d64 waiting on condition  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE

"Attach Listener" #5 daemon prio=5 os_prio=2 cpu=46.88ms elapsed=66.16s tid=0x0000022864816500 nid=0x609c waiting on condition  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE

"Service Thread" #6 daemon prio=9 os_prio=0 cpu=0.00ms elapsed=66.16s tid=0x0000022864819570 nid=0x2c50 runnable  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE

"Monitor Deflation Thread" #7 daemon prio=9 os_prio=0 cpu=0.00ms elapsed=66.16s tid=0x000002286481a5d0 nid=0x6868 runnable  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE

"C2 CompilerThread0" #8 daemon prio=9 os_prio=2 cpu=93.75ms elapsed=66.16s tid=0x0000022864826970 nid=0x5c60 waiting on condition  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE
   No compile task

"C1 CompilerThread0" #11 daemon prio=9 os_prio=2 cpu=93.75ms elapsed=66.16s tid=0x000002286482ce50 nid=0x4f88 waiting on condition  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE
   No compile task

"Sweeper thread" #12 daemon prio=9 os_prio=2 cpu=0.00ms elapsed=66.16s tid=0x000002286482e300 nid=0x207c runnable  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE

"Common-Cleaner" #13 daemon prio=8 os_prio=1 cpu=0.00ms elapsed=66.12s tid=0x000002286492e6c0 nid=0x470c in Object.wait()  [0x00000035b0bfe000]
   java.lang.Thread.State: TIMED_WAITING (on object monitor)
        at java.lang.Object.wait(java.base@17.0.2/Native Method)
        - waiting on <0x000000069a5042a0> (a java.lang.ref.ReferenceQueue$Lock)
        at java.lang.ref.ReferenceQueue.remove(java.base@17.0.2/ReferenceQueue.java:155)
        - locked <0x000000069a5042a0> (a java.lang.ref.ReferenceQueue$Lock)
...
"Monitor Ctrl-Break" #14 daemon prio=5 os_prio=0 cpu=31.25ms elapsed=66.05s tid=0x000002286492eb90 nid=0x1168 runnable  [0x00000035b0cfe000]
   java.lang.Thread.State: RUNNABLE
        ...
        - locked <0x000000069a67ff38> (a java.io.InputStreamReader)
...
"Notification Thread" #15 daemon prio=9 os_prio=0 cpu=0.00ms elapsed=66.05s tid=0x000002286492f530 nid=0x29c8 runnable  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE

"Thread-0" #16 prio=5 os_prio=0 cpu=0.00ms elapsed=66.05s tid=0x00000228649316e0 nid=0x4104 waiting for monitor entry  [0x00000035b0fff000]
   java.lang.Thread.State: BLOCKED (on object monitor)
        at test.thread.DeadLockTest$1.run(DeadLockTest.java:36)
        - waiting to lock <0x000000069a63b080> (a java.lang.StringBuilder)
        - locked <0x000000069a63b048> (a java.lang.StringBuilder)

"Thread-1" #17 prio=5 os_prio=0 cpu=0.00ms elapsed=66.04s tid=0x0000022864931bb0 nid=0x5e14 waiting for monitor entry  [0x00000035b10ff000]
   java.lang.Thread.State: BLOCKED (on object monitor)
        at test.thread.DeadLockTest$2.run(DeadLockTest.java:65)
        - waiting to lock <0x000000069a63b048> (a java.lang.StringBuilder)
        - locked <0x000000069a63b080> (a java.lang.StringBuilder)

"DestroyJavaVM" #18 prio=5 os_prio=0 cpu=171.88ms elapsed=66.04s tid=0x000002286492fed0 nid=0x19b0 waiting on condition  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE

"VM Thread" os_prio=2 cpu=0.00ms elapsed=66.21s tid=0x00000228636a6490 nid=0x4e48 runnable

"GC Thread#0" os_prio=2 cpu=0.00ms elapsed=66.24s tid=0x000002283c540530 nid=0x5324 runnable

"G1 Main Marker" os_prio=2 cpu=0.00ms elapsed=66.24s tid=0x000002283c54d240 nid=0x5244 runnable

"G1 Conc#0" os_prio=2 cpu=0.00ms elapsed=66.24s tid=0x000002283c54fe80 nid=0x4e18 runnable

"G1 Refine#0" os_prio=2 cpu=0.00ms elapsed=66.24s tid=0x000002283c55e000 nid=0x44a8 runnable

"G1 Service" os_prio=2 cpu=0.00ms elapsed=66.24s tid=0x000002283c55e930 nid=0x4df0 runnable

"VM Periodic Task Thread" os_prio=2 cpu=0.00ms elapsed=66.05s tid=0x000002283c557b50 nid=0x48ac waiting on condition
...
3. wait方法与notify方法必须要在`同步代码块`或者是`同步函数`中使用。因为：`必须要通过当前锁对象[同步监视器]调用这2个方法`。否则会报java.lang.IllegalMonitorStateException异常。
...
```java
//线程池完整参数创建
ThreadPoolExecutor pool = new ThreadPoolExecutor(3,//corePoolSize
            3,//maximumPoolSize
            10L,//keepAliveTime
            TimeUnit.MILLISECONDS,//unit
            new LinkedBlockingQueue<Runnable>(),//队列
            new ThreadFactory() {//线程生成工厂
                static int count = 0;
