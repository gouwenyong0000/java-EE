...
![67177892343](images/1.搭建环境/1671778923438-1696867595554-18.png)
...
![01-搭建后端环境](images/1.搭建环境/01-搭建后端环境-1696867595556-19.png)
...
![image-20230111100533606](images/1.搭建环境/image-20230111100533606.png)
...
![image-20230111100718036](images/1.搭建环境/image-20230111100718036.png)
...
![image-20230111100818596](images/1.搭建环境/image-20230111100818596.png)
...
![image-20230111101057835](images/1.搭建环境/image-20230111101057835.png)
...
![image-20230111101704126](images/1.搭建环境/image-20230111101704126.png)

**第二步 修改参数**

![image-20230111101810041](images/1.搭建环境/image-20230111101810041.png)

修改jar包里面文件内容，可以使用压缩工具打开jar包

![image-20230111101848341](images/1.搭建环境/image-20230111101848341.png)

修改当前idea版本

![image-20230111101953957](images/1.搭建环境/image-20230111101953957.png)

**第三步 在idea的File -> Settings -> Plugins下选中修改参数后的安装包进行安装，安装后重启idea**

![image-20230111102104410](images/1.搭建环境/image-20230111102104410.png)



![image-20230111102422788](images/1.搭建环境/image-20230111102422788.png)
...
![image-20230111152230209](images/1.搭建环境/image-20230111152230209.png)
...
![image-20220608092227969](images/1.搭建环境/image-20220608092227969-1696867595556-20.png)
...
![image-20220608093626416](images/1.搭建环境/image-20220608093626416-1696867595556-21.png)
...
![image-20230707021821194](images/1.搭建环境/image-20230707021821194-1696867595557-22.png)
...
![04-角色管理接口](images/1.搭建环境/04-角色管理接口-1696867595557-23.png)
...
![image-20230129090829193](images/1.搭建环境/image-20230129090829193.png)
...
![05-统一异常处理](images/1.搭建环境/05-统一异常处理-1696867595557-24.png)
...
![image-20220601141535949](images/1.搭建环境/image-20220601141535949-1696867595557-25.png)
